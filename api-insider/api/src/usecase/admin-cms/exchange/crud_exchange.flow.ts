...
import CmsBusinessExchange from '../../../core/business/cms/logic/exchange.logic';
import { IExchangeSpot } from '../../../../src/core/interfaces/exchange-spot';

export class CrudExchangeFlow {
  private readonly service;
  constructor(_service: IExchangeSpot) {
  ...
  async list(
    ...
    const dataResult = CmsBusinessExchange.getExchangeList(datas);
    const result = CtrlUtil.getPagingFormat(dataResult, page, limit, total);  
    return result;
  }
}

export default CrudExchangeFlow;
